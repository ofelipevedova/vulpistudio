document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        "pt-BR": {
            ...
            "testimonials.quote3": "O modelo de assinatura manteve tudo simples. Conseguíamos solicitar trabalhos continuamente e ainda manter a consistência da entrega.",
            "testimonials.role3": "Líder de produto",
            "testimonials.quote4": "Eles entenderam a marca rapidamente e traduziram isso em um sistema visual que já parecia premium desde o começo.",
            "testimonials.role4": "Diretor de marketing",
            "testimonials.quote5": "O ritmo foi estável, a comunicação foi clara e a entrega final funcionou bem em todos os dispositivos que testamos.",
            "testimonials.role5": "Fundadora",
            "testimonials.quote6": "Uma combinação forte de sensibilidade e estrutura. Esse equilíbrio facilitou aprovar o trabalho com confiança.",
            "testimonials.role6": "Diretor criativo",
        ...
        "en-US": {
            ...
            "testimonials.role2": "(EXTDS)",
            "testimonials.quote3": "The subscription model kept everything simple. We could request work continuously and still keep the output consistent.",
            "testimonials.role3": "Product Lead",
            "testimonials.quote4": "They understood the brand fast and translated it into a visual system that felt premium from the start.",
            "testimonials.role4": "Marketing Director",
            "testimonials.quote5": "The turnaround was steady, the communication was clean, and the final delivery held up across every device we tested.",
            "testimonials.role5": "Founder",
            "testimonials.quote6": "A strong mix of taste and structure. That balance made it easy for us to approve work with confidence.",
            "testimonials.role6": "Creative Director",
            "footer.copy": "Copyright 2026 - VulpiStudio.",
            "footer.email": "Email",
